...
"""
    ...
    def test_execute_with_actual_llm(self, mocker, instruction: str):
        ...
        mocker.patch.object(src.logger.Logger, 'error', return_value=None)
        mocker.patch.object(src.logger.Logger, 'warning', return_value=None)
        mocker.patch.object(src.logger.Logger, 'debug', return_value=None)
